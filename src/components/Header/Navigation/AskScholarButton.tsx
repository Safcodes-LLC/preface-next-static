  ...
  return (
    <>
      <button
        ...
        className={`flex min-w-[155px] cursor-pointer items-center gap-2 rounded-sm border border-[#EEEEEE] px-5 py-2 text-sm font-normal transition-all duration-200 hover:shadow-sm focus:outline-none dark:border-[#777777] ${
          home
            ? isTransparentHeader
