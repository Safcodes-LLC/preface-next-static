  ...
  return (
    <Popover className={clsx('group', className)}>
      ...
      >
        <div
          className={clsx(
            'flex h-5 items-center justify-center rounded-full px-1 text-sm font-medium',
            home ? 'text-[#fff] dark:text-[#fff]' : 'text-[#000000] dark:text-white'
          )}
        >
      ...
      <PopoverPanel
        ...
        transition
        className={clsx(
          'z-40 bg-white rounded-[4px] p-2 ring-1 ring-black/5 transition duration-200 ease-in-out data-closed:translate-y-1 data-closed:opacity-0 dark:bg-[#0D0D0D]',
          panelClassName
        )}
      >
        <TabGroup>
