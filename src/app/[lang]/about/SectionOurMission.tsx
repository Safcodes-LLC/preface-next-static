...
export default function SectionOurMission() {
  return (
    <div className="">
      <div className="">
        <h2 className="text-3xl font-semibold tracking-tight text-pretty sm:text-4xl lg:text-5xl">Our Mission</h2>
        <p className="mt-6 text-lg/8 text-neutral-600 dark:text-neutral-400">
          The Quran is meant to be read, understood, and reflected upon. Our mission is to remove barriers to access and
          empower individuals and communities by providing a reliable, well-designed, and deeply enriching Quranic
          experience. We aim to serve as a trusted source for anyone seeking to engage with the Quran, guided by the
          principles of accuracy, clarity, and sincerity.
        </p>
      </div>
      {/* <ul
        role="list"
